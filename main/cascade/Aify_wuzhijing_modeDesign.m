...
% chirp1
chirpIdx = 1;
chirps(chirpIdx).Fs = 8e6;%Hz
chirps(chirpIdx).c = 3e8;%m/s
chirps(chirpIdx).S = 78.986000061035156*1e6/1e-6;%Hz/s
...
chirps(chirpIdx).adc_start_time = 6.0e-6;%s
chirps(chirpIdx).ramp_end_time = 40.0e-6;%s
